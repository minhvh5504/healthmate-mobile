...
import '../../../providers/medicine_stock_edit/medicine_stock_edit_notifier.dart';
...
class MedicineStockCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(medicineStockEditProvider);
    final notifier = ref.read(medicineStockEditProvider.notifier);
  ...
  void _showStockCountPopup(
    ...
    MedicineStockEditNotifier notifier,
    int initialCount,
  ) {
    showGeneralDialog(
      context: context,
