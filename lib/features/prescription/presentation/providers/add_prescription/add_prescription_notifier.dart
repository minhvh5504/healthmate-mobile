...
class AddPrescriptionState {
  ...
  bool get isEditMode => initialPrescription != null;
...
class AddPrescriptionNotifier extends StateNotifier<AddPrescriptionState> {
  final CreatePrescription _createPrescription;

  AddPrescriptionNotifier(this._createPrescription, Prescription? prescription)
    : super(AddPrescriptionState.initial(prescription));
