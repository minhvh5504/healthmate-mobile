...
class EditPrescriptionTextField extends StatefulWidget {
  const EditPrescriptionTextField({
    super.key,
    required this.label,
  ...
  @override
  State<EditPrescriptionTextField> createState() =>
      _EditPrescriptionTextFieldState();
}

class _EditPrescriptionTextFieldState extends State<EditPrescriptionTextField> {
  ...
  @override
  void didUpdateWidget(covariant EditPrescriptionTextField oldWidget) {
        ...
        isMultiline
            ...
            : TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder:
                      _border(color: const Color(0xFFB8B3EA), width: 1.2),
                ),
              ),
      ],
    );
