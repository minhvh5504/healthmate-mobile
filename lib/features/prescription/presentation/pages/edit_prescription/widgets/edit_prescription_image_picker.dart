...
class EditPrescriptionImagePicker extends StatelessWidget {
  const EditPrescriptionImagePicker({
    super.key,
    required this.image,
    this.imageUrl,
  ...
  /// Opens full-screen image viewer. Null when no image.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFCFC7FF), width: 1.2),
      ),
      child: hasImage
          ? Stack(
              fit: StackFit.expand,
          ...
          : GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.h),
                  Text(
                    'prescription.add.image_format'.tr(),
                    style: TextStyle(
                      fontFamily: 'Inter',
                      fontSize: 11.sp,
                      fontWeight: FontWeight.w500,
