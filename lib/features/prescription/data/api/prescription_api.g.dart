...
class _PrescriptionApi implements PrescriptionApi {
  _PrescriptionApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<dynamic> getPrescriptions() async {
  ...
  Future<dynamic> createPrescription({
    ...
    _data.fields.add(MapEntry('doctorName', doctorName));
    _data.fields.add(MapEntry('clinicName', clinicName));
